...
public class DynamicCompiler {
	...
	private String addHelperCode(String source) {
		String sourceCode = 
				"public void stringRepresentation(Object s, String name) {\n" +
	            "        try {\n" +
        ...
        source = source.substring(0, index) + importSource + source.substring(index);
        
		// Add the extra source code before the last }
		index = source.lastIndexOf('}');
		source = source.substring(0, index) + sourceCode + source.substring(index);
		return source;
	}
}
